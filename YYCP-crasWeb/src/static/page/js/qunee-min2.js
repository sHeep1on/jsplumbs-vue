...
window.Q = function(t, i, n) {
    ...
    function _r(t, i, n) {
        ...
        var h = null;
        try {
            h = r.toDataURL(zu).replace("image/png", "image/octet-stream");
        } catch(a) {
            xR[Yh](a)
        }
        return {
    ...
    mn[bh] = {
        ...
        _87: function() {
            this._l0.setAttribute("crossOrigin",'Anonymous')
            this._kw = DR;
            var t = this._l0[io],
            i = this._l0[no];
...
//            this) : !1
    ...
    xR.EdgeBundle = CF,
    xR.TreeLayouter = gF,
    xR.name = "Copyright 漏 2017 Chinaoly.com";
    var FF = UD;
    return xR[Bx] = HD,
    xR.about = qD,
    xR[Yx] = "Copyright 漏 2017 Chinaoly.com",
    xR[WD] = di,
    xR[VD] = B$,
    xR.about="Copyright 漏 2017 Chinaoly.com",
